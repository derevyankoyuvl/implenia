...
declare type EyesSpec<TDriver = unknown, TElement = unknown, TSelector = unknown> = types.Core<TDriver, TElement, TSelector>;
export declare class Eyes<TDriver = unknown, TElement = unknown, TSelector = unknown> {
    ...
    setConfiguration(config: Configuration<TElement, TSelector>): void;
    get isOpen(): boolean;
    getIsOpen(): boolean;
    /** @undocumented */
    ...
    open(driver: TDriver, config?: Configuration<TElement, TSelector>): Promise<TDriver>;
    ...
    /** @deprecated */
    checkFrame(element: TElement | types.Selector<TSelector> | string | number, timeout?: number, name?: string): Promise<MatchResultData>;
    /** @deprecated */
    checkElement(element: TElement, timeout?: number, name?: string): Promise<MatchResultData>;
    /** @deprecated */
    checkElementBy(selector: types.Selector<TSelector>, timeout?: number, name?: string): Promise<MatchResultData>;
    /** @deprecated */
    ...
    /** @deprecated */
    checkRegionBy(selector: types.Selector<TSelector>, name?: string, timeout?: number, fully?: boolean): Promise<MatchResultData>;
    /** @deprecated */
    checkRegionInFrame(frame: TElement | types.Selector<TSelector> | string | number, selector: types.Selector<TSelector>, timeout?: number, name?: string, fully?: boolean): Promise<MatchResultData>;
    ...
    setScrollRootElement(scrollRootElement: TElement | types.Selector<TSelector>): void;
    ...
    addProperty(name: string, value: string): ConfigurationData<TElement, TSelector>;
    clearProperties(): ConfigurationData<TElement, TSelector>;
