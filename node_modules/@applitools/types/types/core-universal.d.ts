...
declare type UniversalCore<TDriver, TElement, TSelector> = Omit<Core<TDriver, TElement, TSelector>, 'isDriver' | 'isElement' | 'isSelector'>;
declare type UniversalEyes<TDriver, TElement, TSelector, TType extends 'classic' | 'ufg'> = Omit<Eyes<TDriver, TElement, TSelector, TType>, 'test' | 'running' | 'closed' | 'aborted'>;
...
export declare type ClientSocket<TDriver, TContext, TElement, TSelector> = unknown & Request<UniversalCore<TDriver, TElement, TSelector>, 'Core'> & Request<EyesManager<TDriver, TElement, TSelector, 'classic' | 'ufg'>, 'EyesManager', 'manager'> & Request<UniversalEyes<TDriver, TElement, TSelector, 'classic' | 'ufg'>, 'Eyes', 'eyes'> & Request<Server, 'Server'> & Request<Debug<TDriver, TContext, TElement, TSelector>, 'Debug'> & Command<UniversalSpecDriver<TDriver, TContext, TElement, TSelector>, 'Driver'>;
export declare type ServerSocket<TDriver, TContext, TElement, TSelector> = unknown & Command<UniversalCore<TDriver, TElement, TSelector>, 'Core'> & Command<EyesManager<TDriver, TElement, TSelector, 'classic' | 'ufg'>, 'EyesManager', 'manager'> & Command<UniversalEyes<TDriver, TElement, TSelector, 'classic' | 'ufg'>, 'Eyes', 'eyes'> & Command<Server, 'Server'> & Command<Debug<TDriver, TContext, TElement, TSelector>, 'Debug'> & Request<UniversalSpecDriver<TDriver, TContext, TElement, TSelector>, 'Driver'>;
export {};
