...
export declare type ProcessResources = (options: {
...
export declare type ProcessResourcesSettings = FetchResourceSettings & {
    renderer?: Renderer;
};
export declare type ResourceMapping = Record<string, HashedResource | {
